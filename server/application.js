...
const collectionByFile = new Map([
  ...
  [SESSIONS_FILE,"sessions"],[DEVICE_APPROVALS_FILE,"deviceApprovals"],[PUSH_SUBSCRIPTIONS_FILE,"pushSubscriptions"],[CONTACTS_FILE,"contacts"],[ATTACHMENTS_FILE,"attachments"]
]);
