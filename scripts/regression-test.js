...
assert(client.includes('CLIENT_VERSION = "0.7.0-alpha7.1"'));
assert(html.includes('Conversation UI v0.7.0-alpha7.1'));
...
assert(sw.includes('fibrochat-shell-v0.7.0-alpha7.1'));
...
console.log("Alpha 3–7.1 regression assertions: true");
