...
**Актуальная подготовленная версия:** 0.5.1.
...
## Текущий фокус
Версия 0.5.1 разделяет интерфейс и укрепляет сессии/PIN. Следующий этап — тестирование на Chrome, Android PWA, Safari/macOS и iOS PWA.


Главное изменение v0.5.1: см. `19_PRIVATE_CONTACTS_AND_FIBRO_ID.md`.
